...
export default function LandingPage() {
  ...
  return (
    <main className="bg-white text-gray-900 font-sans">
      ...
      <motion.a
        href="https://t.me/breeeve"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#0088cc] text-white p-3 rounded-full shadow-lg hover:bg-[#0077b3] transition-colors"
                ...
                >
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center items-center">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-black text-white rounded-xl hover:bg-[#1a8cd8] transition-colors"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#1a8cd8] text-white rounded-xl hover:bg-[#0077b3] transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
